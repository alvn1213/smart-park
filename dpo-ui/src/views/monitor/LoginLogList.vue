<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-popconfirm v-has="'monitor:logininfo:clean'" title="确认清空吗？" @confirm="clean">
        <a-icon slot="icon" type="question-circle-o" style="color: red" />
        <a-button type="danger" ghost icon="close">清空</a-button>
      </a-popconfirm>
      <a-dropdown v-has="'monitor:logininfo:remove'" v-if="selectedRowKeys.length > 0">
...
import { getLoginLogList, delLoginLog, cleanLoginLog, cleanOperLog } from '@/api/monitor'
