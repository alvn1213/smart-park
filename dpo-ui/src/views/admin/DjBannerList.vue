...
import { getDjBannerList, delDjBanner, changMarketable } from '@/api/admin/djBanner'
...
export default {
  ...
  data () {
    return {
      ...
      selectedRowKeys: [],
      selectedRows: [],
      addEnable: checkPermission('admin:djBanner:add'),
      editEnabel: checkPermission('admin:djBanner:edit'),
      removeEnable: checkPermission('admin:djBanner:remove')
    }
  },
  filters: {
  },
