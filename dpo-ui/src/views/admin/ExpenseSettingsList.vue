...
import { getExpenseSettingsList, delExpenseSettings, enabled } from '@/api/admin/expenseSettings'
...
export default {
  ...
  data () {
    return {
      ...
      selectedRowKeys: [],
      selectedRows: [],
      addEnable: checkPermission('admin:ExpenseSettings:add'),
      editEnabel: checkPermission('admin:ExpenseSettings:edit'),
      removeEnable: checkPermission('admin:ExpenseSettings:remove')
    }
  },
  filters: {
