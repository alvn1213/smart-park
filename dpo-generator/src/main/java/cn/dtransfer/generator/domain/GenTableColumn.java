package cn.dtransfer.generator.domain;
...
public class GenTableColumn extends BaseEntity {
    ...
    public static boolean isSuperColumn(String javaField) {
        return StringUtils.equalsAnyIgnoreCase(javaField, "id", "version", "createBy", "createTime", "updateBy", "updateTime", "deleteFlag", "tenantId");
    }
