package cn.dtransfer.common.redis.aspect;
...
public class RedisAspect {
     ...
     */
    @Pointcut("@annotation(cn.dtransfer.common.redis.annotation.RedisCache)")
    public void redisCachePoint() {
    }

    @Pointcut("@annotation(cn.dtransfer.common.redis.annotation.RedisEvict)")
