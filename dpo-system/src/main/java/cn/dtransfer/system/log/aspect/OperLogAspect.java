package cn.dtransfer.system.log.aspect;
...
import cn.dtransfer.system.log.enums.BusinessStatus;
...
public class OperLogAspect {
     ...
     * 配置织入点
     */
    @Pointcut("@annotation(cn.dtransfer.system.log.annotation.OperLog)")
    ...
    protected void handleLog(final JoinPoint joinPoint, final Exception e) {
        try {
            // 获得注解
            cn.dtransfer.system.log.annotation.OperLog controllerLog = getAnnotationLog(joinPoint);
            ...
            String username = currentUserService.getLoginName();
     ...
     * @throws Exception
     */
    public void getControllerMethodDescription(cn.dtransfer.system.log.annotation.OperLog log, OperLog operLog, Object[] args) throws Exception {
        // 设置action动作
     ...
     * 是否存在注解，如果存在就获取
     */
    private cn.dtransfer.system.log.annotation.OperLog getAnnotationLog(JoinPoint joinPoint) throws Exception {
        Signature signature = joinPoint.getSignature();
        MethodSignature methodSignature = (MethodSignature) signature;
        Method method = methodSignature.getMethod();
        if (method != null) {
            return method.getAnnotation(cn.dtransfer.system.log.annotation.OperLog.class);
        }
        return null;
    }
}
